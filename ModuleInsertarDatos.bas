...
'        .Range("A1").Value = "ANÁLISIS ESTADÍSTICO - COMPLETADO (#" & numeroHoja & ")" & " [ " & ws.Name & " ] "
'
'        ' INFORMACIÓN METADATA DEL ANÁLISIS
'        Call FormatearEncabezadoSeccion(ws.Range("A2"))
'        .Range("A2").Value = "Fecha del análisis:"
...
'        .Range("A4").Value = "Número de análisis:"
